...
const TableSearchForm = () => {
  ...
  return (
    <div className="relative w-full backdrop-blur-xl bg-gradient-to-r from-black/70 to-slate-900/70 rounded-2xl p-6 shadow-xl border border-slate-700/30">
      {/* Background effects to match the hero background */}
      <div className="absolute inset-0 rounded-2xl overflow-hidden pointer-events-none">
        <div className="absolute -right-20 -top-20 w-56 h-56 bg-gradient-to-r from-emerald-500/10 to-blue-500/10 rounded-full blur-3xl"></div>
        <div className="absolute -left-20 -bottom-20 w-56 h-56 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-full blur-3xl"></div>
      ...
      {/* Content with relative positioning to display above the background effects */}
